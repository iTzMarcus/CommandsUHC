...
public class TcCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		TeamsUtils.sendMessage(TeamsUtils.getTeam(sender.getName()), "§6Team §8| §7" + sender.getName() + " §8⫸ §7x: §6" + player.getLocation().getBlockX() + " §7y: §6" + player.getLocation().getBlockY() + " §7z: §6" + player.getLocation().getBlockZ() + " §8| " + color + world);
		return true;
